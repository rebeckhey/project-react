            ...
            <nav className="navbar sticky-top navbar-light bg-light">
                <div className="container-fluid">
                    ...
                    <div className="d-flex"> 
                        ...
                        <NavLink exact activeClassName="active" className="brand-font nav-links navbar-brand" to="/shoppingcart"><i className="fas fa-shopping-cart"><span className="badge quantity-badge rounded-pill badge-notification bg-danger">{shopQuantity}</span></i></NavLink>
